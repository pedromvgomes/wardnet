...
use wardnet_common::vpn_provider::{ProviderAuthMethod, ProviderInfo, ServerInfo};

use crate::state::AppState;
use crate::tests::stubs::{
    StubDeviceService, StubDhcpServer, StubDhcpService, StubDiscoveryService, StubDnsServer,
    StubDnsService, StubEventPublisher, StubLogService, StubRoutingService, StubSystemService,
    StubTunnelService,
};
use wardnetd_services::LogService;
use wardnetd_services::auth::service::LoginResult;
use wardnetd_services::error::AppError;
use wardnetd_services::{AuthService, VpnProviderService};
...
#[async_trait]
impl VpnProviderService for MockProviderService {
